    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      >
        <tr>
          ...
          <th scope="col" class="py-3 px-6 hidden md:inline-block">Model</th>
          <th scope="col" class="py-3 px-6">Sold To</th>
          <th scope="col" class="py-3 px-6 hidden lg:inline-block">Date</th>
          <th scope="col" class="py-3 px-6 hidden lg:inline-block">Price</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="py-4 px-6 hidden md:inline-block">
            <ul class="text-xs">
          ...
          <td class="py-4 px-6 hidden lg:inline-block">
            ...
            <p>
              <span
                class="mt text-site-green-1 px-2 rounded-full bg-site-green-5"
              >
                Valid Warranty
              </span>
            </p>
          </td>
          <td class="py-4 px-6 hidden lg:inline-block">Frw 200,000</td>
          <td class="py-4 px-6 text-right">
            <ul class="flex justify-between text-site-green-5 text-md">
              <router-link to="/admin/invoice/single">
                <li class="hover:text-site-green-4"><fa icon="eye"></fa></li>
              </router-link>
